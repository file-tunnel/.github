# file-tunnel organization defaults
...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`file-tunnel`](https://github.com/file-tunnel).

## Canonical organization links

- GitHub organization: https://github.com/file-tunnel
- Public organization defaults: https://github.com/file-tunnel/.github
- Canonical Linear project: https://linear.app/denman/project/githubcomfile-tunnel-f46884af1012
...
`file-tunnel` declares repository roles, dependency edges, cross-organization capabilities, deployment ownership, and the git-submodule/Zed-package contract:
