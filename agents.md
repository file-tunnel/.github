...
3. Review linked pull requests, issues, Linear work, related repositories in `file-tunnel`, and relevant external-organization repositories whenever behavior or contracts cross boundaries.
